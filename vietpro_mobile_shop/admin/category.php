...
<script>
    ...
    {
        return confirm('ban muon xoa danh muc: '+name+' ?');
    }
</script>
								...
								<table 
									...
									<tbody>
										<?php
											...
											$list_pages .=  '<li class="page-item"><a class="page-link" href="index.php?page_layout=category&page='.$page_perv.'">&laquo;</a></li>';
											...
											$sql = "SELECT*FROM category ORDER BY cat_id DESC LIMIT $per_rows, $rows_per_page";
										...
										<tr>
											...
											<td class="form-group">
												...
												<a onclick="return delItem('<?php echo $row['cat_name'];?> ')" href="delete_category.php?cat_id=<?php echo $row['cat_id']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
											</td>
										</tr>
