                ...
                <div id="my-cart">
                    ...
                    ?>
                        ...
                        <div class="cart-item row">
                            ...
                            <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo $row['prd_price']*$_SESSION['cart'][$row['prd_id']]; ?></b><a href="modules/cart/del_cart.php?prd_id=<?php echo $row['prd_id']; ?>">Xóa</a></div>    
                        </div>
...
<?php
    if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['mail']) && isset($_POST['add'])){
        ...
        $str_body.='<p>
                        Cám ơn quý khách đã mua hàng tại Shop của chúng tôi, 
                        bộ phận giao hàng sẽ liên hệ với quý khách để xác nhận sau 5 phút 
                        kể từ khi đặt hàng thành công và chuyển hàng đến quý khách chậm nhất sau 24 tiếng.
                    </p>';
...
?>
                ...
                <!--	End Customer Info	-->
<?php }else{ ?>
    <div class="alert alert-danger mt-3">Gio hang cua ban hien khong co san pham nao</div>
<?php } ?>               
