...
?>
                ...
                <div id="product">
                	<div id="product-head" class="row">
                        ...
                        <div id="product-details" class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <ul>
                                ...
                                <li class="<?php if($row['prd_status']==1){echo 'label-success';}else{echo 'label-danger';} ?>" id="status"><?php if($row['prd_status'] == 1){echo 'con hang';}else{ echo 'het hang';} ?></li>
                            </ul>
                    ...
                    <?php
                        ...
                        $rows_per_page = 2; // so ban ghi can hien trong 1 trang
                        ...
                        $list_pages .=  '<li class="page-item"><a class="page-link" href="index.php?page_layout=product&prd_id='.$prd_id.'&page='.$page_perv.'">&laquo;</a></li>';
                    ...
                    <div id="comments-list" class="row">
                    	<div class="col-lg-12 col-md-12 col-sm-12">
                            <?php 
                                $sql_cmts = "SELECT*FROM comment WHERE prd_id = '$prd_id' ORDER BY comm_id DESC LIMIT $per_rows, $rows_per_page";
                                $query_cmts = mysqli_query($conn,$sql_cmts);
                                while($rows_cmt = mysqli_fetch_array($query_cmts)){
                            ?>
                            <div class="comment-item">
                                <ul>
                                    <li><b><?php echo $rows_cmt['comm_name']; ?></b></li>
                                    <li><?php echo $rows_cmt['comm_date']; ?></li>
                                    <li>
                                        <p><?php echo $rows_cmt['comm_details']; ?></p>
                                    </li>
                                </ul>
                            </div>
                                <?php } ?>
